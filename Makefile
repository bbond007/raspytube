OBJS=term.o kbjs.o config.o ui.o main.o tvraw.o gfxlib.o OMXJPEG.o omx_jpeg_wrapper.o OMXComponent.o Event.o OMXCore.o Logger.o Locker.o boing.o
BIN=raspytube.bin
...
LDFLAGS+=-L$(SDKSTAGE)/opt/vc/lib/ -lGLESv2 -lEGL -lopenmaxil -lbcm_host -lvcos -lvchiq_arm -L/opt/vc/src/hello_pi/libs/ilclient -L/opt/vc/src/hello_pi/libs/vgfont -lilclient -ljpeg 
